...
float Batterij_niveau = 200;        // Met deze variabele simuleren we het accu niveau.
float loopTime      = 0.00001;      // Elke ronde zal het batterij percentage met dit getal vermidnerd worden. Zodat het leeg lopen van de batterij gesimuleerd wordt.
...
int main()
{
    ...
    if(Batterij_niveau <= 15) {     // Wanneer het batterij percentage kleiner is dan 15%, gaat het batterij_niveau lampje aan.
        Batterij_led = 1;
            ...
            Batterij_niveau = Batterij_niveau - loopTime;
    }
